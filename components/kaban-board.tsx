  ...
  return (
    <div className="w-full max-w-4xl mx-auto space-y-4">
      {board.columns.map((column: Column, index: number) => {
        ...
        return (
          <Card
            key={column._id} // ✅ stable unique key
            className="w-full shadow-md rounded-lg"
          >
            {/* Column Header */}
            <CardHeader
              className={`${config.color} text-white rounded-t-lg py-3`}
            >
              <div className="flex items-center justify-between">
            ...
            {/* Column Body */}
            <div className="p-4 min-h-[120px] bg-muted/30 rounded-b-lg">
              {/* Tasks will go here */}
            </div>
          </Card>
        );
